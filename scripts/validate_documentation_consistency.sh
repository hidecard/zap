...
pairs=(
  ...
  'docs/TYPECHECK_GENERIC_DECLARATIONS_A3_EN.md:docs/TYPECHECK_GENERIC_DECLARATIONS_A3_MM.md'
...
require_text docs/DOCUMENTATION_NAVIGATION_EN.md 'ZAP_HOST_QUICKSTART_EN.md'
