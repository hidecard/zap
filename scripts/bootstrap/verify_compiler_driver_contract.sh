...
PY
for export in driver_frontend_ownership driver_verified_frontend_acceptance driver_module_resolution_ownership driver_typed_ir_backend_ownership driver_parse_source driver_typecheck_source driver_normalize_module_name driver_module_name_matches driver_module_match_count driver_module_index driver_order_module driver_order_modules driver_module_graph_manifest driver_collect_imports driver_resolve_modules driver_modules_graph_replay driver_source_index driver_check_modules driver_build_modules driver_module_build_manifest driver_modules_rebuild driver_typed_ir_semantics driver_typed_ir_ast_statements driver_typed_ir_nested_coverage_valid driver_typed_ir_expression_coverage_valid driver_typed_ir_node_coverage_valid driver_typed_ir_nodes_coverage_valid driver_typed_ir_ownership driver_finalize_typed_ir driver_promote_typed_ir driver_compile_backend driver_execute_owned_pipeline driver_check_source driver_build_source driver_run_source driver_test_source driver_command driver_build_package driver_artifact_record driver_canonical_artifacts driver_artifact_manifest driver_rebuild driver_subset_run driver_subset_rebuild driver_seed_pipeline_digest driver_seed_compile_bytes driver_seed_compile_source driver_seed_pipeline_replay driver_seed_self_rebuild driver_seed_self_rebuild_ast driver_seed_incomplete_assignment_diagnostic driver_seed_emit_inferred_program_typed_ir driver_seed_compile_inferred_typed_ir_source driver_seed_self_rebuild_inferred_typed_ir driver_seed_supported_subset_run driver_seed_supported_subset_rebuild driver_seed_a13_supported_rebuild_evidence driver_seed_artifact_record_valid driver_seed_pipeline_artifacts_valid driver_seed_owned_pipeline_contract driver_seed_package_artifact_contract; do
...
if grep -q 'import "bootstrap/b4/native_independent.zp"' "$CONTRACT" "$DRIVER"; then
