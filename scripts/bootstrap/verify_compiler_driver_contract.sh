...
PY
for export in driver_parse_source driver_typecheck_source driver_normalize_module_name driver_module_name_matches driver_collect_imports driver_resolve_modules driver_typed_ir_semantics driver_compile_backend driver_execute_owned_pipeline driver_check_source driver_build_source driver_run_source driver_test_source driver_build_package driver_artifact_record driver_canonical_artifacts driver_artifact_manifest driver_rebuild driver_subset_run driver_subset_rebuild; do
