...
let constructor = driver_seed_compile_source("class Box:\n    fn __init__(self, value):\n        set self.value = value\n        return self\nlet box = Box(7)\nsay box.value", "constructor.zp")
let inherited = driver_seed_compile_source("class Animal:\n    fn speak(self):\n        return 1\n    fn __init__(self, value):\n        set self.value = value\n        return self\nclass Dog extends Animal:\n    fn bark(self):\n        return 2\nlet dog = Dog(7)\nsay dog.speak()\nsay dog.bark()\nsay dog.value", "inherited.zp")
let override = driver_seed_compile_source("class Animal:\n    fn speak(self):\n        return 1\nclass Dog extends Animal:\n    fn speak(self):\n        return 3\nlet dog = Dog()\nsay dog.speak()", "override.zp")
let bad_arity = driver_seed_compile_source("class Needs:\n    fn __init__(self, value):\n        return self\nlet needs = Needs()", "bad_arity.zp")
let ast = driver_seed_compile_ast_source("class Animal:\n    fn speak(self):\n        return 1\n    fn __init__(self, value):\n        self.value = value\n        return self\nclass Dog extends Animal:\n    fn bark(self):\n        return 2\nlet dog = Dog(7)\nsay dog.speak()\nsay dog.bark()\nsay dog.value", "ast_inherited.zp")
