...
Release artifacts are published through the repository's GitHub Actions workflow. Verify the published checksums and use the official [v0.9.3 release](https://github.com/hidecard/zap/releases/tag/v0.9.3) or a later official release when distributing Zap.
