...
Release artifacts are published through the repository's GitHub Actions workflow. Verify the published checksums and use the official [v2.2.3 release](https://github.com/hidecard/zap/releases/tag/v2.2.3) or a later official release when distributing Zap. The historical v2.2.0 tag and assets remain immutable.
