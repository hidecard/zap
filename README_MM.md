...
သင့် operating system နှင့် CPU architecture ကိုက်ညီသော archive ကို [v2.11.12 release page](https://github.com/hidecard/zap/releases/tag/v2.11.12) မှ download လုပ်ပြီး checksum/signature verify လုပ်ကာ extract လုပ်ပါ။
...
မျှော်မှန်းထားသော archive သည် `zap-2.11.12-windows-x86_64.zip` ဖြစ်ပါသည်။
