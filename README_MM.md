...
ခွင့်ပြုထားသော dependency graph ကို သီးခြား `chore/dependency-remediation-v2.2.7` branch တွင် တည်ဆောက်ပြီး [PR #2](https://github.com/hidecard/zap/pull/2) ဖြင့် review လုပ်ကာ `master` သို့ merge ပြီးနောက် final CI နှင့် release validation များ pass ဖြစ်သဖြင့် v2.2.7 အဖြစ် ထုတ်ဝေထားပါသည်။
