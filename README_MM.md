...
သင့် operating system နှင့် CPU architecture ကိုက်ညီသော archive ကို [v2.9.0 release page](https://github.com/hidecard/zap/releases/tag/v2.9.0) မှ download လုပ်ပြီး checksum/signature verify လုပ်ကာ extract လုပ်ပါ။
...
မျှော်မှန်းထားသော archive သည် `zap-2.9.0-windows-x86_64.zip` ဖြစ်ပါသည်။
...
လက်ရှိ source baseline သည် v2.9.0 ဖြစ်ပါသည်။ v2.3.0၊ v2.2.7 နှင့် အစောပိုင်း release record များကို [GitHub Releases](https://github.com/hidecard/zap/releases) နှင့် bilingual `CHANGELOG` file များတွင် ဆက်လက်ကြည့်ရှုနိုင်ပါသည်။ Release artifact များကို version consistency၊ native test၊ cross-platform build၊ security check၊ documentation check နှင့် installer verification များ pass ပြီးမှသာ publish လုပ်ပါသည်။
