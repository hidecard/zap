...
- Pins Rust 1.88.0 for the remediation branch and CI quality job because `time 0.3.47` requires it; the candidate remains unpublished until clean-commit, GitHub CI, final preflight, and artifact verification gates pass.
