...
fn create_web_project(dir: &Path) -> Result<(), String> {
    ...
    write_scaffold_file(
        ...
        "zap.lock",
        &format!(
            r#"# This file is generated by Zap. Do not edit manually.
lockfile_version = 1
