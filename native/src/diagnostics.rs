...
impl ZapError {
    ...
    pub(crate) fn io(message: String) -> Self {
        Self::Io {
            message,
            file: String::new(),
            line: 0,
    ...
    pub(crate) fn value(message: String) -> Self {
        Self::Value {
            message,
            file: String::new(),
            line: 0,
    ...
    pub(crate) fn file_not_found(message: String) -> Self {
        Self::FileNotFound {
            message,
            file: String::new(),
            line: 0,
    ...
    pub(crate) fn with_location(mut self, file: String, line: usize, column: usize) -> Self {
        match &mut self {
            Self::Syntax { file: f, line: l, column: c, .. }
            | Self::Name { file: f, line: l, column: c, .. }
            | Self::Type { file: f, line: l, column: c, .. }
            | Self::Json { file: f, line: l, column: c, .. }
            | Self::Value { file: f, line: l, column: c, .. }
            | Self::Io { file: f, line: l, column: c, .. }
            | Self::FileNotFound { file: f, line: l, column: c, .. }
            | Self::Key { file: f, line: l, column: c, .. }
            | Self::Permission { file: f, line: l, column: c, .. }
            | Self::Overflow { file: f, line: l, column: c, .. }
            | Self::Runtime { file: f, line: l, column: c, .. }
            | Self::Borrow { file: f, line: l, column: c, .. }
            | Self::Memory { file: f, line: l, column: c, .. }
            | Self::Project { file: f, line: l, column: c, .. } => {
                *f = file;
                *l = line;
                *c = column;
            }
...
mod tests {
    ...
    #[test]
    fn redact_sensitive_information_hides_keys() {
