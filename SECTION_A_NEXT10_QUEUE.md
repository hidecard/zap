...
| 8 | General typed-IR emitter | [x] bounded regression | B2 typed-IR differential still passes; environment/index/generic helper results are not yet wired to arbitrary typed-IR production. |
...
- `scripts/bootstrap/verify_b2_type_generic_10.sh` — now covers 15 inference/generic cases
