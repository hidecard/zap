...
| `runtime_state.rs` | Per-run `RuntimeState`, `MemoryBudget`, `ObjectStore`, workspace-root ownership, module-cache isolation, import-cycle tracking, execution-depth accounting, and reset-detached lifecycle statistics | Implemented M2-MEM-02 foundation |
