...
Download the archive matching your operating system and CPU architecture from the [v2.11.14 release page](https://github.com/hidecard/zap/releases/tag/v2.11.14), verify its checksum and signature, extract it, and place the `zap` executable on `PATH`.
...
The expected archive is `zap-2.11.14-windows-x86_64.zip`.
