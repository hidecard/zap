.PHONY: native native-run native-test host-test legacy-test bootstrap-b1-arbitrary-test bootstrap-b1-full-corpus-test bootstrap-b1-parser-corpus-test bootstrap-non-rust-test bootstrap-driver-contract-test bootstrap-driver-module-test bootstrap-frontend-ownership-test bootstrap-backend-ownership-test bootstrap-byte-determinism-test bootstrap-second-stage-test bootstrap-clean-env-test bootstrap-self-rebuild-test test package clean
...
bootstrap-b1-full-corpus-test:
	bash scripts/bootstrap/verify_b1_full_language_corpus.sh

bootstrap-b1-parser-corpus-test:
	bash scripts/bootstrap/verify_b1_full_language_parser.sh
...
bootstrap-frontend-ownership-test:
	bash scripts/bootstrap/verify_b4_frontend_ownership_slice.sh
...
test: legacy-test native-test host-test bootstrap-test bootstrap-b1-test bootstrap-b1-arbitrary-test bootstrap-b1-full-corpus-test bootstrap-b1-parser-corpus-test bootstrap-b3-test bootstrap-vm-test bootstrap-clean-repo-test bootstrap-refactor-smoke-test bootstrap-non-rust-test bootstrap-driver-contract-test bootstrap-driver-module-test bootstrap-frontend-ownership-test bootstrap-backend-ownership-test bootstrap-self-rebuild-test
