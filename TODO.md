...
- [ ] Platform seed ဖြင့် complete Zap compiler source ကိği clean environment တွင် compile/run လုပ်ရန်။ (လက်ရှိတွင် bounded Rust-free seed slice သာ အောင်မြင်; actual platform seed artifact လိုအပ်ပါသည်)
