...
- [ ] **Platform-seed acceptance** — Zap-written runner contract သည် clock/console/file/memory ကို allow၊ network/process ကို deny ပြီး stage ownership၊ structural validity နှင့် deterministic produced-artifact handoff ကို စစ်ဆေးကာ ၁၀-case verifier pass ထားသော်လည်း status သည် `contract_only` ဖြစ်ပြီး bootstrap output ကို platform seed မှ self-build/run လုပ်နိုင်ကြောင်း မပြနိုင်သေးပါ။
