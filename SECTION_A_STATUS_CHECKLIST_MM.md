...
- [ ] **General typed-IR production** — declaration/list/map emission၊ generic type-alias node၊ generic/function metadata၊ arithmetic/comparison/logical binary expression နှင့် multi-argument positional call emission ကို တိုးချဲ့ထားသော်လည်း nested argument splitting၊ arbitrary blocks နှင့် complete typed-IR integration မပြီးသေးပါ။
