...
Async domain သည် eager future များကို အသုံးပြုသော ပထမဆုံး language-level task facade ကို ပေးထားပါသည်။ `async_capabilities()` သည် ဘယ်အလုပ်က deterministic၊ worker-backed၊ bounded၊ cancellable၊ deferred သို့မဟုတ် unsupported ဖြစ်သည်ကို report လုပ်ပေးပြီး descriptive သာဖြစ်ကာ worker၊ network သို့မဟုတ် process operation တစ်ခုမျှ မစတင်ပါ။ Public catalog သည် deterministic ဖြစ်ပါသည်။ Builtin တစ်ခုစီသည် တစ်ကြိမ်သာ ပါဝင်ပြီး domain တစ်ခုတည်းနှင့်သာ သက်ဆိုင်ပါသည်။ Native runtime ထဲတွင် tooling နှင့် tests များအသုံးပြုသော catalog ပါရှိသဖြင့် documentation နှင့် implementation တို့ကို တစ်ပြေးညီ ထိန်းသိမ်းနိုင်ပါသည်။
