...
လက်ရှိ release line တွင် API များကို direct builtin များအဖြစ် အသုံးပြုနိုင်ပါသည်။ ဖော်ပြထားသော domain နှင့် builtin အားလုံးကို v2.9.0 development line အတွက် stable၊ active deprecation window မရှိ၊ release-target platform matrix ကို ထောက်ပံ့ပြီး explicit schema-2 determinism class ပါရှိသည်ဟု catalog တွင် မှတ်တမ်းတင်ထားပါသည်။ Change checklist အတွက် [stability policy](STDLIB_POLICY_MM.md) ကို ကြည့်ပါ။ Namespace import syntax နှင့် remote standard-library package များကို P1 verification ပြီးနောက် Ecosystem milestone အတွက် ဆက်လက်လုပ်ဆောင်ပါမည်။
