...
| Registry index နှင့် file-backed cache foundation | ပြီးစီး | JSON index validation၊ exact version selection၊ deterministic file-backed cache၊ SHA-256 enforcement နှင့် offline reuse ကို environment configuration ဖြင့် support လုပ်သည်။ HTTP transport နှင့် publishing များမှာ roadmap ဖြစ်သည်။ |
