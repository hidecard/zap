...
| P1-05 | Conformance/property/fuzz test layers | Partial | Parser golden-style unit test များ၊ deterministic parser/lexer/JSON/lockfile/registry-security corpus များ၊ collection regression များနှင့် async cancellation/scheduler cases များကို `scripts/test_p105_layers.sh` မှတစ်ဆင့် CI တွင် မြင်နိုင်ပြီ။ Linux၊ Windows နှင့် macOS build/test matrix coverage ကို ဆက်လက် run လုပ်သည်။ Dedicated fuzz target များ၊ ပိုမိုကျယ်ပြန့်သော allocation/heap regression များနှင့် platform-specific input case များကို ဆက်လက်ထည့်ရန် ကျန်ရှိသည်။ |
