...
၈။ **M2-ASYNC-02:** ပြီးစီးပြီး။ Cooperative language task cancellation၊ poll-budget timeout join၊ deterministic `Cancelled`/`TimedOut` diagnostic၊ bilingual contract update နှင့် end-to-end regression coverage များကို အကောင်အထည်ဖော်ပြီးဖြစ်သည်။
၉။ **P2-02/P2-03/P2-04:** Stdlib policy၊ tooling parity နှင့် documentation navigation ပြီးစီးရန်။
၁၀။ **P2-01:** Parser/runtime မပြောင်းမီ traits/composition RFC ကို ရေးသားပြီး review လုပ်ရန်။
