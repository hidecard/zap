...
**အခြေခံအခြေအနေ:** Zap v2.1.12 verified release
...
၆။ **P0-04/P0-RS-01:** Checked-borrow နှင့် ပထမဆုံး explicit runtime-state slices များ ပြီးစီးထားသည်။ ကျန်ရှိသော weak-reference၊ closure/process-wide telemetry၊ per-run byte accounting၊ arbitrary-cycle reclamation၊ tracing-collector design နှင့် broader hidden-state migration အလုပ်များကိုသာ ဆက်လုပ်ရန်။
