...
Publication မလုပ်မီ v2.2.6 release candidate သည် strict formatting၊ warnings-denied Clippy၊ locked compilation၊ native unit/integration suite အပြည့်အစုံ၊ filesystem/process/network/security corpus၊ project/lockfile test၊ LSP နှင့် VS Code parity၊ documentation consistency၊ standard-library policy၊ ownership/parity/replay/async matrix၊ packaging နှင့် clean tagged-name release preflight များကို အောင်မြင်ရမည်။ သက်ဆိုင်ရာ local နှင့် GitHub gate များ မပြီးမချင်း ဤ section တွင် verification ပြီးစီးကြောင်း မရေးရပါ။ Release preflight နှင့် tag-triggered release workflow နှစ်ခုလုံးသည် `scripts/check_rustsec_audit.sh` နှင့် `RUN_CARGO_AUDIT=1` မှတစ်ဆင့် modern RustSec audit ကို enforce လုပ်ထားပါသည်။ လက်ရှိ locked graph တွင် `idna 0.4.0`၊ `rustls-webpki 0.102.8` နှင့် development-only `time 0.3.30` တို့နှင့် သက်ဆိုင်သော advisory များကို မှတ်တမ်းတင်ထားပါသည်။ Repository ၏ explicit lockfile policy အောက်တွင် audit pass မရမချင်း dependency remediation ပြီးစီးသည်ဟု မဆိုရပါ။ လက်ရှိ audit တွင် advisory ခြောက်ခု ဆက်လက်တွေ့ရှိသဖြင့် ဤ candidate ကို publication မပြုနိုင်သေးပါ။
