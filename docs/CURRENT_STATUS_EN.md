...
**Status label:** active
**Latest published release:** [v2.11.9](https://github.com/hidecard/zap/releases/tag/v2.11.9)
**Next release line:** v2.11.10 preparation
**Bootstrap stage:** B0
...
The latest published release is v2.11.9. Its tag and workflow record are immutable release evidence; a later release must use a new tag and must not rewrite prior tags. Each published release includes a versioned manifest, aggregate checksums, detached signatures, and a signed provenance asset.
