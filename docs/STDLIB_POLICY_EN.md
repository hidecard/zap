...
The policy applies to the current release line, **v2.11.15**, and is intended to be reviewed whenever a public builtin is added, changed, deprecated, or removed.
