...
Zap v2.9.1 သည် ပထမဆုံးအသုံးပြုချိန် developer experience နှင့် production-facing default များကို ပြင်ဆင်သည့် maintenance release ဖြစ်ပါသည်။ Web project အသစ်ဖန်တီးရာတွင် သတ်မှတ်ထားသော project name ကို မှန်ကန်စွာသုံးပြီး linter-compatible source ထုတ်ပေးကာ documented validation workflow ကို ဖြတ်နိုင်ပါသည်။

Unix installer သည် `ZAP_INSTALL_DIR` သတ်မှတ်ထားပါက default `~/.local/bin` အစား သတ်မှတ်ထားသော directory ကို shell profile ထဲတွင် PATH အဖြစ် မှန်ကန်စွာ သိမ်းပေးပါသည်။ Makefile သည် actual legacy test suite ကို ညွှန်ပြပြီး locked native၊ host၊ legacy နှင့် aggregate test target များ ပေးထားပါသည်။
