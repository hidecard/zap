...
**ရည်ရွယ်ချက်:** Native runtime ၏ dependency version များ၊ local audit evidence၊ tool limitation နှင့် CI/release control များကို မှတ်တမ်းတင်ရန် ဖြစ်သည်။ ဤစာတမ်းသည် v2.2.6 ကို publish လုပ်ပြီးပြီဟု ဆိုလိုခြင်း မဟုတ်ပါ။

## လက်ရှိ lockfile dependency graph

Native lockfile တွင် security နှင့်ဆိုင်သော package များကို အောက်ပါအတိုင်း သတ်မှတ်ထားပါသည်။ Repository ၏ Rust 1.75 toolchain compatibility မပျက်စေရန် compiler အသစ်လိုအပ်သော transitive crate အချို့ကို pin လုပ်ထားပါသည်။

| Package | Locked version | အသုံးပြုသည့်နေရာ | Audit အခြေအနေ |
|---|---:|---|---|
| `ureq` | `2.12.1` | HTTP client | `2.9.7` မှ update လုပ်ထားသည် |
| `rustls` | `0.23.43` | TLS implementation | `0.22.4` မှ update; ring-only feature သုံးထားသည် |
| `rustls-webpki` | `0.103.15` | Web PKI certificate validation | `0.102.8` မှ update; current patched line ဖြစ်သည် |
...
| `idna_adapter` | `1.2.0` | IDNA backend | Rust 1.75-compatible pin ဖြစ်သည် |
| `litemap` | `0.7.4` | IDNA backend support | Rust 1.75-compatible pin ဖြစ်သည် |
| `zeroize` | `1.8.2` | Secret-memory cleanup support | Rust 1.75-compatible pin ဖြစ်သည် |
...
Repository-compatible Rust toolchain ဖြင့် `cargo-audit 0.21.1` ကို local environment တွင် တပ်ဆင်ထားပါသည်။ သို့သော် ဤ version ၏ parser သည် current RustSec database ထဲရှိ CVSS 4.0 value ပါသော record များကို မဖတ်နိုင်ဘဲ unsupported CVSS version ဟု ပြန်ပေးပါသည်။
...
Time crate ၏ current stack-exhaustion advisory သည် `0.3.47` မတိုင်မီ RFC 2822 parsing path များနှင့် သက်ဆိုင်ပါသည်။[^3] Project ၏ Rust 1.75 compatibility boundary ကို ကျော်လွန်၍ toolchain တစ်ခုလုံး update မလုပ်ဘဲ dependency ကို graph မှ ဖယ်ရှားထားပါသည်။
...
Dependency update များကို repository ၏ pinned Rust compatibility policy နှင့်အညီ ဆက်လက်ထိန်းသိမ်းရမည် ဖြစ်သည်။ အနာဂတ်တွင် Rust toolchain update လုပ်ပါက compatibility pin များကို ပြန်လည်စစ်ဆေးပြီး compiler အသစ်က ခွင့်ပြုသောအခါ older transitive version များကို ဖယ်ရှားနိုင်ပါသည်။
