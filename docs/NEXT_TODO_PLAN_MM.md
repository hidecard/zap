...
**အခြေခံအခြေအနေ:** Zap v2.1.12 verified release ဖြစ်ပြီး P0-03 Structured Diagnostics ကို `master` branch တွင် ပြီးစီးထားသည်။
...
| 3 | **P0-04 Memory နှင့် reference-cycle စာချုပ်** | Partial | Ownership policy၊ bounded memory behavior နှင့် deterministic cycle-breaking diagnostics | M1 — Runtime safety |
| 4 | **P0-05 Deterministic နှင့် production async boundary** | Partial | Deterministic executor နှင့် production I/O/blocking work ကို တိတိကျကျ ခွဲခြားသတ်မှတ်ခြင်း | M1 — Runtime safety |
| 5 | **P1-05 Conformance၊ property နှင့် fuzz layers** | Partial | ပိုမိုကျယ်ပြန့်သော panic-free၊ deterministic နှင့် platform-aware verification | M2 — Verification |
| 6 | **P0-01 Native/legacy conformance စာချုပ်** | Partial | Native behavior ကို canonical သတ်မှတ်ပြီး executable legacy-parity report နှင့် migration policy ရှိခြင်း | M2 — Verification |
| 7 | **P0-02 ပေါင်းစည်းထားသော language specification** | Partial | Syntax၊ typing၊ runtime behavior၊ compatibility နှင့် version decision များအတွက် semantic index တစ်ခုတည်းရှိခြင်း | M2 — Verification |
| 8 | **P2-02 Standard-library API stability policy** | Partial | Public API တိုင်းတွင် stability label၊ deprecation rule၊ versioning rule နှင့် platform record ပါခြင်း | M3 — Tooling နှင့် documentation |
| 9 | **P2-03 LSP နှင့် VS Code semantic parity** | Partial | Rename၊ module-aware indexing၊ async-aware editor behavior နှင့် parser/AST parity ကို release-test လုပ်နိုင်ခြင်း | M3 — Tooling နှင့် documentation |
| 10 | **P2-04 Learning/reference documentation ခွဲခြားခြင်း** | Partial | Learner၊ reference၊ specification၊ package-author၊ runtime နှင့် deployment content များကို versioned navigation ဖြင့် ခွဲခြားခြင်း | M3 — Tooling နှင့် documentation |
| 11 | **P2-01 Composition နှင့် traits/interfaces RFC** | Deferred | Parser/runtime ပြောင်းလဲမှု မစမီ reviewed design ရှိခြင်း | M4 — Language design |
