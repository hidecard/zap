...
P0/P1 safety gates များပြီးနောက် P2-02 standard-library stability နှင့် P2-03 LSP/VS Code parity ကို M3-STDLIB-01 နှင့် M3-LSP-01 အဖြစ် ပြီးစီးထားသည်။ ယခု P2-04 documentation navigation နှင့် learning/reference documentation ကို M3-DOC-01 အဖြစ် ဆက်လုပ်မည်။ P2-01 traits/composition သည် conformance/specification contract များ မပြီးမချင်း RFC-only milestone အဖြစ် ဆက်ရှိမည်။
