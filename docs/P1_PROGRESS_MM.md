...
| P1-05 conformance/property/security layer runner | အခြေခံအဆင့် အကောင်အထည်ဖော်ပြီး | `scripts/test_p105_layers.sh` သည် deterministic parser၊ lexer၊ JSON၊ lockfile၊ registry-security၊ collection၊ cancellation နှင့် async-scheduler regression များကို run လုပ်သည်။ CI တွင် Linux၊ Windows နှင့် macOS build/test matrix coverage ကိုလည်း ဆက်လက်ထားရှိသည် |
