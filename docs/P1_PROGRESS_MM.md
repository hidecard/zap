...
| 6 | Package determinism နှင့် CLI tooling | တစ်စိတ်တစ်ပိုင်း | Lockfile/deterministic dependency behavior၊ diagnostics၊ filtering၊ formatting၊ project checks နှင့် version/help consistency များ တည်ငြိမ်ရမည် |
