...
**Purpose:** This document records the dependency versions, local audit evidence, tool limitations, and CI/release controls for the native runtime. It is an evidence record for the v2.11.3 development line, not a claim that an untagged development commit is a published release.
