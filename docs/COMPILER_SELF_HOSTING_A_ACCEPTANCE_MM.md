...
A2 design gate တွင် arithmetic၊ text addition၊ boolean logic၊ comparison နှင့် result construction ကို cover လုပ်သော Rust-reference-backed exact-expression matrix အသေးတစ်ခုကို ယခု implement နှင့် verify လုပ်ပြီးဖြစ်သည်။ A1 complete inference နှင့် A2 broader cross-product coverage များသည် ဆက်လက် open ဖြစ်သည်။ ရှိပြီးသား literal၊ constructor သို့မဟုတ် exact-expression slice များကို complete inference ဟု မယူဆဘဲ evidence ကို အဆင့်လိုက် တိုးချဲ့ရမည်။
