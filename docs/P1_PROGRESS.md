...
| P1-05 conformance/property/security layer runner | Implemented (initial) | `scripts/test_p105_layers.sh` runs deterministic parser, lexer, JSON, lockfile, registry-security, collection, cancellation, and async-scheduler regressions; CI also retains Linux, Windows, and macOS build/test matrix coverage |
