...
**နောက်ဆုံး publish လုပ်ထားသော release:** [v2.11.11](https://github.com/hidecard/zap/releases/tag/v2.11.11)
**နောက် release line:** v2.11.13 corrective release preparation
**Bootstrap stage:** B0
...
နောက်ဆုံး publish လုပ်ထားသော release သည် v2.11.11 ဖြစ်သည်။ v2.11.12 tag ကို macOS ARM64 release workflow မအောင်မြင်ပြီးနောက် ထိန်းသိမ်းထားသော်လည်း public v2.11.12 release မထုတ်ဝေခဲ့ပါ။ ၎င်း၏ tag နှင့် workflow record များသည် immutable incident evidence ဖြစ်ပြီး နောက် release သည် tag အသစ်ကိုသာ အသုံးပြုရမည်၊ ယခင် tag များကို rewrite မလုပ်ရ။ Publish လုပ်ထားသော release တစ်ခုစီတွင် versioned manifest၊ aggregate checksum၊ detached signature နှင့် signed provenance asset ပါဝင်သည်။
