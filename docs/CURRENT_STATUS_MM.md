...
**နောက် release line:** v2.11.12 preparation
**Bootstrap stage:** B0
...
| B2 type-checker candidate | provisional | Selected declaration၊ conditional၊ function၊ call၊ bounded list-element diagnostic၊ paired nested-list index slice၊ bounded text-key map-element slice၊ bounded direct-`is_some` branch-local option-narrowing slice နှင့် bounded direct-`is_some` loop-body/loop-boundary restoration slice များ ပါဝင်သည်။ |
