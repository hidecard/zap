...
**နောက်ဆုံး publish လုပ်ထားသော release:** [v2.11.13](https://github.com/hidecard/zap/releases/tag/v2.11.13)
**နောက် release line:** v2.11.14 preparation
**Bootstrap stage:** B0
...
| B2 type-checker candidate | provisional | Selected declaration၊ conditional၊ function၊ call၊ bounded list-element diagnostic၊ paired nested-list index slice၊ bounded text-key map-element slice၊ bounded direct-`is_some` branch-local option-narrowing slice၊ bounded direct-`is_some` loop-body/loop-boundary restoration slice နှင့် bounded direct `is_option_none` else-body slice နှင့် bounded direct bool-literal annotation slice များ ပါဝင်သည်။ |
