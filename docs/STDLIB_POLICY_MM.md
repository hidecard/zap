...
**စစ်ဆေးထားသော baseline:** Zap v2.11.10
...
ဤ policy သည် လက်ရှိ release line ဖြစ်သော **v2.11.10** အတွက် သက်ရောက်ပြီး public builtin တစ်ခုကို ထည့်ခြင်း၊ ပြင်ခြင်း၊ deprecated ပြုလုပ်ခြင်း သို့မဟုတ် ဖယ်ရှားခြင်းတိုင်းတွင် ပြန်လည်သုံးသပ်ရမည်။
...
| `web` | stable | 2.1.14 | none | minor-compatible | Linux, Windows, macOS ARM64 | 64 KiB JSON/map body နှင့် schema field 64 ခု | bounded error map ပါသော typed Result value | not applicable | pure |
