...
GitHub Actions သည် Rust quality job အတွင်း command တူကို run လုပ်ပြီး `target/spec-ownership-report.tsv` ကို commit-named artifact အဖြစ် upload လုပ်ပါသည်။ Index ထဲတွင် fragmented rule အားလုံးကို ဆက်လက်ချဲ့ထွင်နိုင်သော်လည်း ဤ slice တွင် စတင်ထားသော stable ID၊ required-domain coverage နှင့် bilingual ownership field များကို မပြောင်းလဲရပါ။
