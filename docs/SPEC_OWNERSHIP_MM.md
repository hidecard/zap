...
Machine-readable [`SPEC_OWNERSHIP_INDEX.tsv`](SPEC_OWNERSHIP_INDEX.tsv) သည် canonical Zap specification အတွက် ပထမ executable ownership slice ဖြစ်ပါသည်။ Public rule တစ်ခုချင်းစီ၏ English section၊ Burmese section၊ implementation သို့မဟုတ် conformance fixture owner၊ implementation status နှင့် compatibility class ကို row တစ်ကြောင်းစီတွင် သတ်မှတ်ထားပါသည်။ ထို့ကြောင့် rule တစ်ခုသည် အဟောင်း guide တွင် ပါနေခြင်း သို့မဟုတ် legacy runtime က လက်ခံနေခြင်းတစ်ခုတည်းကြောင့် normative ဖြစ်သွားခြင်းကို ကာကွယ်ပါသည်။
...
Validator သည် bilingual document နှစ်ခုနှင့် section reference များ ရှိ/မရှိ၊ fixture owner file နှင့် fragment ရှိ/မရှိ၊ policy value များ မှန်/မမှန်နှင့် index တွင် အဓိပ္ပါယ်ရှိသော row အရေအတွက် ရှိ/မရှိကို စစ်ဆေးပါသည်။ Report သည် row တစ်ကြောင်းစီ၏ `PASS` သို့မဟုတ် `FAIL` decision ပါသော deterministic TSV output ဖြစ်ပါသည်။
...
GitHub Actions သည် Rust quality job အတွင်း command တူကို run လုပ်ပြီး `target/spec-ownership-report.tsv` ကို commit-named artifact အဖြစ် upload လုပ်ပါသည်။ နောက် specification slice များတွင် fragmented rule အားလုံးကို index ထဲ ထပ်မံထည့်နိုင်သော်လည်း ဤ slice တွင် စတင်ထားသော stable ID နှင့် bilingual ownership field များကို မပြောင်းလဲရပါ။
