...
**အခြေအနေ:** Zap v2.10.1 အတွက် B0 reference baseline
...
ပထမဆုံး provisional Zap-owned type-checker candidate ကို [`bootstrap/b2/typecheck.zp`](../bootstrap/b2/typecheck.zp) တွင် ထည့်ထားပြီး [`scripts/bootstrap/verify_b2_typecheck_candidate.sh`](../scripts/bootstrap/verify_b2_typecheck_candidate.sh) သည် annotated နှင့် conditional fixture များ၏ deterministic acceptance နှင့် incompatible-number diagnostic ကို enforce လုပ်သည်။ ဤ candidate သည် corpus-limited ဖြစ်ပြီး general expression inference၊ generic/variant narrowing၊ function checking နှင့် diagnostic parity အပြည့်အစုံ မလုပ်သေးပါ။ Native Rust သည် reference owner အဖြစ် ဆက်ရှိပြီး bootstrap stage သည် B0 အဖြစ်သာ ဆက်ရှိသည်။
...
လက်ရှိ implementation gate သည် staged parity expansion ဖြစ်သည်။ Zap-owned lexer နှင့် parser candidate များသည် owned corpus ကို ဆက်လက်ချဲ့ထွင်ပြီး valid၊ Unicode၊ malformed၊ overflow နှင့် determinism case များတွင် Rust reference နှင့် output နှိုင်းယှဉ်ရမည်။ B2 typed-IR/type-check conformance foundation နှင့် ပထမ provisional Zap-owned checker candidate ကို enforce လုပ်ပြီးဖြစ်သော်လည်း type checking နှင့် typed IR အပြည့်အစုံသည် native-owned အဖြစ်သာ ရှိသေးသည်။ နောက် ownership step သည် checker ကို three-fixture corpus ထက်ကျော်လွန်၍ expression inference၊ function annotation၊ generic/variant behavior နှင့် diagnostics အပြည့်အစုံအထိ ချဲ့ပြီး ထို analysis တစ်ခုတည်းမှ typed IR ထုတ်လုပ်ခြင်း ဖြစ်သည်။ VM နှင့် native backend အလုပ်များကို ထို gate များမကျော်မီ ပြီးစီးသည်ဟု မဆိုရ။
