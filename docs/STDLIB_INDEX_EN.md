...
| `runtime` | Bounded memory diagnostics and capability reporting | `memory_stats` |
| `async` | Deterministic tasks, cancellation, timeout, and capability reporting | `spawn`, `task_join`, `task_is_ready`, `async_capabilities` |
