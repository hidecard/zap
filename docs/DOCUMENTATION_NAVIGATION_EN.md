...
| Framework contributor | [Framework guide](FRAMEWORK_EN.md) — v2.2.3 | [Zap-first Web guide](ZAP_WEB_NATIVE_EN.md), [Web Framework guide](WEB_FRAMEWORK_EN.md), [frontend integration guide](FRONTEND_INTEGRATION_EN.md), [zap-host adapter](ZAP_HOST_EN.md), [zap-host quickstart](ZAP_HOST_QUICKSTART_EN.md), [Framework starters](../frameworks), [ecosystem roadmap](ECOSYSTEM.md) |
...
| Framework adapters | [Framework guide](FRAMEWORK_EN.md) · [Zap-first Web guide](ZAP_WEB_NATIVE_EN.md) · [Web Framework guide](WEB_FRAMEWORK_EN.md) · [frontend integration guide](FRONTEND_INTEGRATION_EN.md) · [zap-host adapter](ZAP_HOST_EN.md) · [zap-host quickstart](ZAP_HOST_QUICKSTART_EN.md) | Zap-first scaffold checks, starter smoke tests, Web contract tests, host-capability contract tests, and Axum/Tower adapter tests |
