...
| Framework contributor | [Framework guide](FRAMEWORK_EN.md) | [Web Framework guide](WEB_FRAMEWORK_EN.md), [Framework starters](../frameworks), [ecosystem roadmap](ECOSYSTEM.md), [package guide](PACKAGE_EN.md) |
...
| Framework contributor | [Framework guide](FRAMEWORK_EN.md) — v2.2.3 | [Web Framework guide](WEB_FRAMEWORK_EN.md), [Framework starters](../frameworks), [ecosystem roadmap](ECOSYSTEM.md) |
...
| Framework adapters | [Framework guide](FRAMEWORK_EN.md) · [Web Framework guide](WEB_FRAMEWORK_EN.md) | Starter smoke tests, Web contract tests, host-capability contract tests, and adapter parity tests |
