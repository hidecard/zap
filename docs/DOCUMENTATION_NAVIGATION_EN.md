...
| Bootstrap/self-hosting | [Bootstrap and self-hosting contract](BOOTSTRAP_CONTRACT_EN.md) · [Section-A acceptance contract](COMPILER_SELF_HOSTING_A_ACCEPTANCE_EN.md) | B0 status, canonical token/AST/diagnostic artifacts, B0 verifier, and ordered A1–A13 acceptance gates |
