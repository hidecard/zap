...
| Framework contributor | [Framework guide](FRAMEWORK_EN.md) | [Web Framework guide](WEB_FRAMEWORK_EN.md), [zap-host adapter](ZAP_HOST_EN.md), [zap-host quickstart](ZAP_HOST_QUICKSTART_EN.md), [Framework starters](../frameworks), [ecosystem roadmap](ECOSYSTEM.md), [package guide](PACKAGE_EN.md) |
...
|---|---|---|
| Learner | [Learning guide](LEARN_ZAP_EN.md) — v2.2.3 | [Syntax reference](SYNTAX_GUIDE_EN.md) |
| Language user | [Syntax reference](SYNTAX_GUIDE_EN.md) — v2.2.3 | [Language specification](LANGUAGE_SPEC_EN.md) |
| Package author | [Package guide](PACKAGE_EN.md) — v2.2.3 | [Stdlib reference](STDLIB_INDEX_EN.md), [registry contract](REGISTRY_AUTH_EN.md) |
| Framework contributor | [Framework guide](FRAMEWORK_EN.md) — v2.2.3 | [Web Framework guide](WEB_FRAMEWORK_EN.md), [zap-host adapter](ZAP_HOST_EN.md), [zap-host quickstart](ZAP_HOST_QUICKSTART_EN.md), [Framework starters](../frameworks), [ecosystem roadmap](ECOSYSTEM.md) |
| Runtime maintainer | [Memory model](MEMORY_MODEL_EN.md) — v2.2.3 | [Runtime state](RUNTIME_STATE_EN.md), [memory budget](MEMORY_BUDGET_OBJECT_STORE_EN.md) |
| Deployment/security operator | [Deployment boundaries](DEPLOYMENT_EN.md) — v2.2.3 | [Security policy](../SECURITY.md), [release signing](RELEASE_SIGNING_EN.md) |
...
| Framework adapters | [Framework guide](FRAMEWORK_EN.md) · [Web Framework guide](WEB_FRAMEWORK_EN.md) · [zap-host adapter](ZAP_HOST_EN.md) · [zap-host quickstart](ZAP_HOST_QUICKSTART_EN.md) | Starter smoke tests, Web contract tests, host-capability contract tests, and Axum/Tower adapter tests |
