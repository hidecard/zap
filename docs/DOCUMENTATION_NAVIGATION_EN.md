...
| Release operator | [Release version policy](RELEASE_VERSION_POLICY_EN.md) | [Current status](CURRENT_STATUS_EN.md), [Release signing](RELEASE_SIGNING_EN.md), [rollback runbook](RELEASE_ROLLBACK_RUNBOOK_EN.md), [benchmark contract](BENCHMARK_HARNESS_EN.md), [RustSec audit evidence](RUSTSEC_AUDIT_EN.md), [post-v2.2.0 remediation/provenance](POST_V2.2.0_REMEDIATION_EN.md), [post-v2.4.0 remediation/provenance](POST_V2.4.0_REMEDIATION_EN.md), [v2.11.9 release notes](RELEASE_2.11.9_EN.md), [branch hygiene and merge record](BRANCH_HYGIENE_EN.md), [release preflight](../scripts/release_preflight.sh) |
...
|---|---|---|
| Learner | [Language Guide](LEARN_ZAP_EN.md) — v2.11.9 | [Syntax reference](SYNTAX_GUIDE_EN.md) |
| Language user | [Syntax reference](SYNTAX_GUIDE_EN.md) — v2.11.9 | [Language specification](LANGUAGE_SPEC_EN.md) |
| Package author | [Package guide](PACKAGE_EN.md) — v2.11.9 | [Stdlib reference](STDLIB_INDEX_EN.md), [registry contract](REGISTRY_AUTH_EN.md) |
| Framework contributor | [Framework guide](FRAMEWORK_EN.md) — v2.11.9 | [Zap-first Web guide](ZAP_WEB_NATIVE_EN.md), [Web Framework guide](WEB_FRAMEWORK_EN.md), [frontend integration guide](FRONTEND_INTEGRATION_EN.md), [production deployment](PRODUCTION_DEPLOYMENT_EN.md), [database operations](DATABASE_PRODUCTION_EN.md), [OAuth2/JWT authentication](AUTH_OAUTH2_JWT_EN.md), [load/chaos testing](LOAD_CHAOS_TESTING_EN.md), [zap-host adapter](ZAP_HOST_EN.md), [zap-host quickstart](ZAP_HOST_QUICKSTART_EN.md), [Framework starters](../frameworks), [ecosystem roadmap](ECOSYSTEM.md) |
| Runtime maintainer | [Memory model](MEMORY_MODEL_EN.md) — v2.11.9 | [Runtime state](RUNTIME_STATE_EN.md), [memory budget](MEMORY_BUDGET_OBJECT_STORE_EN.md) |
| Deployment/security operator | [Deployment/security boundaries](DEPLOYMENT_EN.md) — v2.11.9 | [Production operations](PRODUCTION_OPERATIONS_EN.md), [Security policy](../SECURITY.md), [release signing](RELEASE_SIGNING_EN.md), [RustSec audit evidence](RUSTSEC_AUDIT_EN.md) |
