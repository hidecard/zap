...
| Deployment operator | [Deployment guide](DEPLOYMENT_EN.md) | [Production operations](PRODUCTION_OPERATIONS_EN.md), [Cloud deployment guide](DEPLOYMENT_CLOUD_EN.md), [Registry deployment policy](../deploy/registry-deployment-policy.toml), [security policy](../SECURITY.md), [B4 certification plan](B4_CERTIFICATION_ACTION_PLAN.md), [RustSec audit evidence](RUSTSEC_AUDIT_EN.md) |
...
| Bootstrap engineer | [Rust-independence roadmap](RUST_INDEPENDENCE_ROADMAP_EN.md) | [Self-hosting acceptance contract](COMPILER_SELF_HOSTING_A_ACCEPTANCE_EN.md), [B4 certification action plan](B4_CERTIFICATION_ACTION_PLAN.md), [B0 baseline](../bootstrap/BASELINE_B0.md), Rust-free seed-pipeline gate |
