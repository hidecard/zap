...
| Deployment operator | [Deployment guide](DEPLOYMENT_MM.md) | [Production operations](PRODUCTION_OPERATIONS_MM.md)၊ [Cloud deployment guide](DEPLOYMENT_CLOUD_EN.md)၊ [Registry deployment policy](../deploy/registry-deployment-policy.toml)၊ [security policy](../SECURITY.md)၊ [B4 certification plan](B4_CERTIFICATION_ACTION_PLAN.md)၊ [RustSec audit evidence](RUSTSEC_AUDIT_MM.md) |
...
| Bootstrap engineer | [Rust-independence roadmap](RUST_INDEPENDENCE_ROADMAP_MM.md) | [Self-hosting acceptance contract](COMPILER_SELF_HOSTING_A_ACCEPTANCE_MM.md)၊ [B4 certification action plan](B4_CERTIFICATION_ACTION_PLAN.md)၊ [B0 baseline](../bootstrap/BASELINE_B0.md)၊ Rust-free seed-pipeline gate |
...
| Bootstrap/self-hosting | [Bootstrap နှင့် self-hosting contract](BOOTSTRAP_CONTRACT_MM.md) · [Section-A acceptance contract](COMPILER_SELF_HOSTING_A_ACCEPTANCE_MM.md) · [A3 generic-declaration record](TYPECHECK_GENERIC_DECLARATIONS_A3_MM.md) | B0 status၊ canonical token/AST/diagnostic artifact၊ B0 verifier နှင့် ordered A1–A13 acceptance gate များ |
