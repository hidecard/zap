...
| Bootstrap/self-hosting | [Bootstrap နှင့် self-hosting contract](BOOTSTRAP_CONTRACT_MM.md) · [Section-A acceptance contract](COMPILER_SELF_HOSTING_A_ACCEPTANCE_MM.md) | B0 status၊ canonical token/AST/diagnostic artifact၊ B0 verifier နှင့် ordered A1–A13 acceptance gate များ |
