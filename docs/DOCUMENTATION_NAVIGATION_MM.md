...
|---|---|---|
| Learner | [Zap Language Guide](LEARN_ZAP_MM.md) — v2.11.4 | [Syntax guide](SYNTAX_GUIDE.md) |
| Language user | [Syntax guide](SYNTAX_GUIDE.md) — v2.11.4 | [Language specification](LANGUAGE_SPEC_MM.md) |
| Package author | [Package guide](PACKAGE.md) — v2.11.4 | [Stdlib reference](STDLIB_INDEX_MM.md)၊ [registry contract](REGISTRY_AUTH_MM.md) |
| Framework contributor | [Framework guide](FRAMEWORK_MM.md) — v2.11.4 | [Zap-first Web guide](ZAP_WEB_NATIVE_MM.md)၊ [Web Framework guide](WEB_FRAMEWORK_MM.md)၊ [frontend integration guide](FRONTEND_INTEGRATION_MM.md)၊ [production deployment](PRODUCTION_DEPLOYMENT_MM.md)၊ [database operations](DATABASE_PRODUCTION_MM.md)၊ [OAuth2/JWT authentication](AUTH_OAUTH2_JWT_MM.md)၊ [load/chaos testing](LOAD_CHAOS_TESTING_MM.md)၊ [zap-host adapter](ZAP_HOST_MM.md)၊ [zap-host quickstart](ZAP_HOST_QUICKSTART_MM.md)၊ [Framework starters](../frameworks)၊ [ecosystem roadmap](ECOSYSTEM.md) |
| Runtime maintainer | [Memory model](MEMORY_MODEL_MM.md) — v2.11.4 | [Runtime state](RUNTIME_STATE_MM.md)၊ [memory budget](MEMORY_BUDGET_OBJECT_STORE_MM.md) |
| Deployment/security operator | [Deployment/security boundaries](DEPLOYMENT_MM.md) — v2.11.4 | [Production operations](PRODUCTION_OPERATIONS_MM.md)၊ [Security policy](../SECURITY.md)၊ [release signing](RELEASE_SIGNING_MM.md)၊ [RustSec audit evidence](RUSTSEC_AUDIT_MM.md) |
