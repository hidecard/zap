...
Zap's current verified baseline is v2.1.9. P2 package, async, registry, and editor work is tracked as deterministic foundations with explicit production-boundary limitations.
