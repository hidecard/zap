...
| Registry index, HTTPS transport, and cache foundation | Implemented foundation | JSON index validation, exact version selection, local/HTTPS index and artifact transport, deterministic content-addressed cache, SHA-256 enforcement, and offline reuse are supported through explicit configuration. |
