...
| Complex narrowing | Nested boolean expression၊ loop၊ reassignment နှင့် incompatible alias များ | ကျန် | Conformance fixtures အသစ် |
| Complex inference | Nested call၊ collection element နှင့် control-flow expression များ | ကျန် | Conformance fixtures အသစ် |
