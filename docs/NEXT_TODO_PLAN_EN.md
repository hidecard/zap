...
P2-02 standard-library stability, P2-03 LSP/VS Code parity, and P2-04 documentation navigation are complete as M3-STDLIB-01, M3-LSP-01, and M3-DOC-01. P2-01 traits/composition remains an RFC-only milestone until the conformance and specification contracts are complete.
