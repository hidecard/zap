...
**Baseline:** Zap v2.2.1 is the current verified published release. The v2.2.0 tag and assets remain immutable; the later LSP, VS Code, standard-library, and documentation corrections are post-release `master` work published in v2.2.1.
...
| v2.2.1 | Published and verified | New patch tag and release assets from a clean version-consistent commit; v2.2.0 was not retagged or rewritten. |
