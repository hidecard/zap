...
**Baseline:** Zap v2.2.2 is the current verified published release. The v2.2.0, v2.2.1, and v2.2.2 tags and assets remain immutable; the later runtime, equality, borrow, and LSP hardening changes are post-release `master` work pending the next patch release.
