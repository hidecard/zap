...
**Verified baseline:** v2.7.0
**Scope:** Static checking, control-flow narrowing, diagnostics, and conformance fixtures

This document defines the acceptance boundary for the next type-system workstream. It deliberately separates behavior that is already implemented from work that still requires a design decision or implementation. Its verified release metadata is v2.7.0; this release does not reopen the completed async runtime, registry, or release-engineering work.
