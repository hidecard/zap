...
| Complex narrowing | Nested boolean expressions, loops, reassignment, and incompatible aliases | Remaining | New conformance fixtures |
| Complex inference | Nested calls, collection elements, and control-flow expressions | Remaining | New conformance fixtures |
