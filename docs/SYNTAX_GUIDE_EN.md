...
> **Supported version:** Zap v2.11.18\
> **Last verified:** 2026-09-01 against the native runtime, CLI, formatter, LSP, v2.1-D async/tooling implementation, and the bounded canonical AST closure slice shipped in v2.11.18.
